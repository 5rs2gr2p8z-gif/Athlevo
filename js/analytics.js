 ...
 *
 *  PostHog is initialized by the official snippet in index.html. This wrapper
 *  retains its guarded loader as a fallback for builds that inject only the
 *  public project key (POSTHOG_KEY), never a private key.
 */
(function (root) {
  "use strict";
  ...
  function initPostHog() {
    ...
    try {
      var existing = posthog();
      if (existing && (existing.__SV || existing.__loaded)) return;
