...
(function () {
  ...
  function ensureCoachCommandStyles() {
    ...
    style.textContent = [
      ...
      ".cm-status-attention{color:var(--danger,#a52a2f);font-weight:700;}",
      ".cm-status-monitor{color:var(--warning,#9a6505);font-weight:700;}",
      ...
      ".cm-note-confirm{position:fixed;inset:0;z-index:90;display:grid;place-items:center;padding:18px;background:var(--backdrop,rgba(0,0,0,.38))}.cm-note-confirm-dialog{width:min(100%,360px);box-sizing:border-box;background:var(--bg,#fff);border:1px solid var(--line,#e5e5e5);padding:20px}.cm-note-confirm-dialog h2{margin:0;font-family:var(--serif,serif);font-size:21px;font-weight:520}.cm-note-confirm-dialog p{margin:7px 0 18px;color:var(--ink3,#737373);font-size:12px}.cm-note-confirm-actions{display:flex;justify-content:flex-end;gap:16px}",
