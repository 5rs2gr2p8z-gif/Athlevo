...
(function () {
  ...
  function ensureCoachCommandStyles() {
    ...
    style.textContent = [
      ...
      ".cm-open-row:hover .cm-row-name{color:var(--red,#C0272D);}",
      ...
      ".cm-review:hover{border-color:var(--ink2,#6d7075);}",
      ...
      ".cm-refresh,.cm-review,.cm-open-row,.cm-filter,.cm-athlete-back,.cm-athlete-tab,.cm-week-btn,.cm-workout-row,.cm-week-nav button,.cm-add-workout,.cm-note-action,.cm-athlete-message,.cm-msg-item,.cm-msg-thread-back,.cm-msg-athlete-detail,.cm-msg-send,.cm-global-athlete{transition:opacity var(--motion-press) var(--ease-standard),transform var(--motion-press) var(--ease-standard),color var(--motion-press) var(--ease-standard),border-color var(--motion-press) var(--ease-standard)}",
      ".cm-refresh:active,.cm-review:active,.cm-open-row:active,.cm-filter:active,.cm-athlete-back:active,.cm-athlete-tab:active,.cm-week-btn:active,.cm-workout-row:active,.cm-week-nav button:active,.cm-add-workout:active,.cm-note-action:active,.cm-athlete-message:active,.cm-msg-item:active,.cm-msg-thread-back:active,.cm-msg-athlete-detail:active,.cm-msg-send:active,.cm-global-athlete:active{opacity:.86;transform:scale(.985)}",
