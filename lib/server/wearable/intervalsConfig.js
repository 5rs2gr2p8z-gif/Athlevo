...
export const INTERVALS_APP_RETURN_ORIGIN = "https://athlevo.org";

// Athlevo reads completed activities plus the provider's daily CTL/ATL/load
// wellness history for Trends. We deliberately do NOT request WRITE,
// CALENDAR, CHATS, LIBRARY or SETTINGS scopes.
export const INTERVALS_SCOPE = "ACTIVITY:READ,WELLNESS:READ";
...
export function getAppReturnOrigin() {
  // OAuth state selects only the fixed web or native return channel. It never
  // carries or authorizes an arbitrary URL, and preview environment values
  // cannot redirect a completed provider connection away from Athlevo.
  return INTERVALS_APP_RETURN_ORIGIN;
}
