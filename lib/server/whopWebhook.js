 ...
 *       table (status vocabulary: active | past_due | grace |
...
export function mapWhopEvent(event, opts = {}) {
  ...
  if (isRefund) {
    ...
    // Freemium has no timed trial entitlement. A Whop-verified valid
    // membership is simply paid active, regardless of Whop's billing label.
