...
export const AI_LIMITS = {
  ...
  // Anonymous Coach preview (pre-signup). Anonymous, so tighter than
  // authenticated coach chat; mirrors diagnostic-chat's limit shape.
  "coach-anonymous": { limit: 20, windowMinutes: 60 },
  // Cross-browser handoff token creation (pre-signup). One per action that
  // genuinely needs an external browser (Google OAuth / wearable / explicit
  // "continue in Safari"), so this should stay rare per visitor.
  "handoff-create": { limit: 10, windowMinutes: 60 }
};
